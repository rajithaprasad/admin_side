...
import { Users, Award, Clock, MapPin, Star, Truck, ShieldCheck, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24 bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="mt-8 bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-semibold py-3 px-8 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105">
            Get a Free Quote
          </button>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-12 relative inline-block">
              Our Story
              <span className="block w-24 h-1 bg-purple-600 mt-2 mx-auto"></span>
            </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <Card key={index} className="shadow-sm hover:shadow-lg transition-all transform hover:-translate-y-2 border-0">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="hover:shadow-lg transition-all border-0 shadow-sm">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-purple-700 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <button className="bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-semibold py-3 px-8 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105">
            Get Your Free Quote
          </button>
        </div>
      </section>
